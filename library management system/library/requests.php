...
<?php
			...
			$locate =mysql_query("select * from request");
...
echo "<th>book</th>";
			...
			while($rows=mysql_fetch_array($locate)){
				...
				echo"<td title ='Edit Status'><a href=\"review.php?book=$rows[book] &author=$rows[author] &category= $rows[category]\"><center><img src='img/edit.png'></center></a></td>
				    <td title ='Delete'><a href=\"deleterequest.php?id=$rows[id] &book=$rows[book]\"><center><img src='img/delete.png'></center></a></td>";
				echo "</tr>";
